...
<body>
  <div class="card">
    <div class="card-header">
      <label style="font-family: 'Times New Roman', Times, serif; font-size: 50px; letter-spacing: 4px; word-spacing: 3px;">My Home Page</label> 
    </div>
    <div class="card-body" style="font-family: 'Times New Roman', Times, serif; font-size: 25px;">
      <label class="card-title">ABOUT ME</label>
      <p class="card-text">I am <label style="font-weight: bold;">Mark Kevin Cariño</label></p>
      <p ></p>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-6">
        ...
        <button id="image1Like" type=button style="background-color:#5EA1F8;"><label style="color: black; font-weight: bold;">Like</label> &nbsp <output id="numberLikes1" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image1Heart" type=button style="background-color:#F34DA0;"><label style="color: black; font-weight: bold;">Heart</label> &nbsp <output id="numberHeart1" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image1Laugh" type=button style="background-color:#E1BC00;"><label style="color: black; font-weight: bold;">Laugh</label> &nbsp <output id="numberLaugh1" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image1Wow" type=button style="background-color:#DE7D1D;"><label style="color: black; font-weight: bold;">Wow</label> &nbsp <output id="numberWow1" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image1Sad" type=button style="background-color:#00BB4A;"><label style="color: black; font-weight: bold;">Sad</label> &nbsp <output id="numberSad1" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image1Angry" type=button style="background-color:#FF2F2F;"><label style="color: black; font-weight: bold;">Angry</label> &nbsp <output id="numberAngry1" style="color: black; font-weight: bold;">0</output></button>
      </div>
      <div class="col-6">
        <img src="mybetterhalf.jpg" class="img-thumbnail" style="width:500px;height:667px;" /> <br><br>
        <button id="image2Like" type=button style="background-color:#5EA1F8;"><label style="color: black; font-weight: bold;">Like</label> &nbsp <output id="numberLikes2" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image2Heart" type=button style="background-color:#F34DA0;"><label style="color: black; font-weight: bold;">Heart</label> &nbsp <output id="numberHeart2" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image2Laugh" type=button style="background-color:#E1BC00;"><label style="color: black; font-weight: bold;">Laugh</label> &nbsp <output id="numberLaugh2" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image2Wow" type=button style="background-color:#DE7D1D;"><label style="color: black; font-weight: bold;">Wow</label> &nbsp <output id="numberWow2" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image2Sad" type=button style="background-color:#00BB4A;"><label style="color: black; font-weight: bold;">Sad</label> &nbsp <output id="numberSad2" style="color: black; font-weight: bold;">0</output></button> &nbsp
        <button id="image2Angry" type=button style="background-color:#FF2F2F;"><label style="color: black; font-weight: bold;">Angry</label> &nbsp <output id="numberAngry2" style="color: black; font-weight: bold;">0</output></button>
      </div>
    </div>
  </div>
  <script>
